...
const candidateNavItems = [
  ...
  { href: '/live-jobs-2', label: 'Live Jobs 2', icon: Zap, color: 'text-blue-600', bgColor: 'bg-blue-100' },
  ...
  { href: '/emails', label: 'Email Center', icon: Mail, color: 'text-indigo-600', bgColor: 'bg-indigo-100' },
